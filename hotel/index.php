...
<body>
  ...
  <div id="mySidenav" class="sidenav" style="overflow: auto;margin-bottom: 250px;">
          ...
          <form action="submitted_data.php" method="post" style="font-size: 20px;padding-left: 50px;padding-right: 50px;">
            ...
            <div class="row">
              ...
              <div class="col-md-6" style="padding-left: 1%;padding-right: 1%">
                ...
                <div style="text-align: left;"><b>Hotel or Destination</b></div>
                  <div>
                    <input type="text" placeholder="Destination" name="destination" style="width: 100%;text-align: center;">
                  </div>
                ...
                <div class="col-md-3" style="padding-left: 1%;padding-right: 1%">
                  ...
                  <div style="text-align: left;"><b>Check in date</b></div>
                    <div>
                      <input type="date" placeholder="check-in-date" name="check-in-date" style="width: 100%;text-align: center;">
                    </div>
                ...
                <div class="col-md-3" style="padding-left: 1%;padding-right: 0%">
                  ...
                  <div>
                    <input type="date" placeholder="check-out-date" name="check-out-date" style="width: 100%;text-align: center;">
                  </div>
                ...
                <div class="row" style="margin-top: 80px;">
                  ...
                  <div class="col-md-12" style="padding-left: 2%;padding-right: 1%;">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div style="text-align: left;"><b>Rooms</b></div>
                          <div>
                            <input type="number" placeholder="Rooms Needed" name="number-of-rooms" style="width: 100%;text-align: center;">
                          </div>                      
                        </div>
                      ...
                      <div>
                        <input type="number" placeholder="No. of adults (10+)" name="number-of-adults" style="width: 100%;text-align: center;">
                      </div>
                      ...
                      <div>
                        <input type="number" placeholder="No. of children (10-)" name="number-of-children" style="width: 100%;text-align: center;">
                      </div>
                ...
                <div class="row" style="margin-top: 40px;">
                  ...
                  <div class="col-md-6" style="padding-left: 2%; padding-right: 1%;">
                    <input type="submit" style="padding-left: 0%; padding-right: 0%; width: 100%; height: 60px; font-size: 25px;background-color: #00B0FF;">
                  </div>
